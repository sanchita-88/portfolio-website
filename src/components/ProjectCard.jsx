...
const ProjectCard = ({ project }) => {
  return (
    <motion.div className="w-[280px] sm:w-[350px] md:w-[450px] lg:w-[500px] flex flex-col gap-5 relative rounded-lg sm:p-7 py-5 px-5 shadow-2xl shadow-black-200 bg-[#32303a] transition-all duration-200 select-none">
      <div
        className="absolute -top-10 md:-top-16 left-1/2 transform -translate-x-1/2 w-16 h-16 md:w-20 md:h-20 rounded-xl overflow-hidden shadow-xl z-20"
      ...
      {/* Project Details */}
      <div className="flex flex-col gap-5 text-white-600 my-2 pt-12 md:pt-14">
